...
public enum InputType {
    ...
    LIST("list", CedarFieldValueType.LITERAL, null, false),

    TEXTFIELD("textfield", null, null, false),

    TEXTAREA("textarea", null, null, false),

    NUMERIC("numeric", CedarFieldValueType.LITERAL, null, false),

    SECTION_BREAK("section-break", null, null, true),

    PHONE_NUMBER("phone-number", CedarFieldValueType.LITERAL, null, false),

    EMAIL("email", CedarFieldValueType.LITERAL, JsonSchemaFormat.EMAIL, false),

    TEMPORAL("temporal", CedarFieldValueType.LITERAL, JsonSchemaFormat.DATE_TIME, false),

    LINK("link", CedarFieldValueType.IRI, JsonSchemaFormat.URI, false),

    ATTRIBUTE_VALUE("attribute-value", CedarFieldValueType.LITERAL, null, true);
