...
public class TemplateSchemaReporter {
  ...
  public TemplateSchemaReporter(TemplateSchemaArtifact templateSchema)
  {
    TemplateSchemaReporter.ReporterVisitor reporterVisitor = new TemplateSchemaReporter.ReporterVisitor(templateSchema);
  ...
  public Collection<FieldSchemaArtifact> getFieldSchemas(){
    return fieldSchemas.values();
  }
  ...
  public Collection<ElementSchemaArtifact> getElementSchemas(){
    return elementSchemas.values();
  }
