...
public class Csv2ArtifactsCommand implements CedarCliCommand {
    ...
    private final ExampleTemplateInstanceGenerator exampleTemplateInstanceGenerator;
    ...
    public Csv2ArtifactsCommand(CedarArtifactPoster importer,
                                ...
                                ExampleTemplateInstanceGenerator exampleTemplateInstanceGenerator) {
        this.importer = importer;
        this.cedarCsvParserFactory = cedarCsvParserFactory;
        this.writer = writer;
        this.docsGenerator = docsGenerator;
        this.exampleTemplateInstanceGenerator = exampleTemplateInstanceGenerator;
    }
    ...
    public Integer call() throws Exception {
        ...
        try {
            ...
            if(generateExampleTemplateInstance) {
                ...
                exampleTemplateInstanceGenerator.writeExampleTemplateInstance(rootNode, exampleInstancePath,
                                                                              "Example Metadata Instance",
                                                                              "Example generated by CEDARCSV",
                                                                              templateId);
            }
